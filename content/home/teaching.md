...
[[experience]]
  ...
  <a href="https://github.com/gtolomei/theory-of-algorithms/tree/main/lectures/slides" target="_blank">
  <button style="background-color:#6f9fd8;margin-top:6px;margin-bottom:16px;border-radius:4px;font-size:1em;padding:8px 20px;    font-family: "GibsonSemibold", "Helvetica Neue", Helvetica, Arial, sans-serif;float:none !important;text-shadow:0 1px 1px rgba(0, 0, 0, 0.2)">
  Slides
  </button>
  </a>
...
[[experience]]
  title = "<a href='https://github.com/gtolomei/operating-systems' target='_blank' style='color:grey'>Operating Systems (Sistemi Operativi) [BSc Computer Science]</a>"
  company = "Sapienza University of Rome"
  company_url = "https://www.di.uniroma1.it/en"
  location = "Italy"
...
[[experience]]
  title = "<a href='https://github.com/gtolomei/python-for-datascience' target='_blank' style='color:grey'>Python Programming for Data Science [MSc Data Science]</a>"
